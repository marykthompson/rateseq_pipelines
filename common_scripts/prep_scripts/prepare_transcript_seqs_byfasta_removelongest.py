...
#the remove longest version, I'm going to remove transcripts >200k in unspliced versin as this is causing salmon index building to fail. Possibly it would work with RSEM (used by Neel) but I don't want to change my whole workflow now
