...
# TODO:
- plot of % pulldown relative to input using spike-in ratios
"""
...
def main():
    ...
    for i in range(0, len(total_cols)):
        ...
        #def scatter_plot(df, cols = None, label_index_level = None, axis_title_suffix = '', title = '', limits = None, ticklabels = None):
